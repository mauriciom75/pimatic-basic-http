module.exports = {
  ...
  BasicHttpSwitch: {
    ...
    properties: {
      ...
      getStateCommand: {
        description: "the url to execute to get current state. Can return on/off, true/false or 1/0 as string",
        type: "string",
        required: false
      },
      getStateVerb: {
        description: "the http verb to execute to get current state. Can return on/off, true/false or 1/0 as string",
        type: "string",
        required: false
      },
      interval: {
        description: "the time in ms, the url gets executed to get the actual state. If 0 then the state will not updated automatically.",
        type: "integer",
        "default": 0
      },
      forceExecution: {
        description: "always execute url even if switch already is set to the requested state",
        type: "boolean",
        "default": false
      }
    }
